...
const leaderboardsSubTabs = [
  { label: "All Time", href: "/dashboards/leaderboards/all-time" },
  { label: "Challenges", href: "/dashboards/leaderboards/challenges" },
  { label: "Hall of Fame", href: "/dashboards/leaderboards/hall-of-fame" },
];
