...
/**
 * PortalTabs — top-level dashboard navigation.
 *
...
type Tab = {
  label: string;
  href: string;
  /** URL prefix that means "this tab is active" — e.g. /dashboards/leaderboards */
  matchPrefix: string;
};
...
const tabs: Tab[] = [
  {
    label: "Leaderboards",
    href: "/dashboards/leaderboards",
    matchPrefix: "/dashboards/leaderboards",
  },
  {
    label: "Player Stats",
    href: "/dashboards/player-stats",
    matchPrefix: "/dashboards/player-stats",
  },
];
...
export function PortalTabs() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[90rem] items-stretch gap-1 px-4 sm:gap-2 sm:px-8 lg:px-12">
        {tabs.map((tab) => {
