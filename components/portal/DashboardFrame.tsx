...
export function DashboardFrame({
  ...
  return (
    ...
    // section layout's horizontal padding. On sm+ we reset to flow normally
    // and let the parent container's max-width center the frame.
    // The -mx-4 matches the section layout's px-4; sm:mx-0 restores normal flow.
